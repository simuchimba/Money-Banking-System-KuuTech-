...
class Account : public user
{
  ...
  public:
    void accntgetdata()
	{
	  ...
	  {
	   five:
	   cout<<"\n\t\t\t Enter Initial Amount (>= ZMK 500) : ";
	   cin>>blnc;
	   if(blnc<500){
	     cout<<"\n\t\t\t Please Enter greater than ZMK 500"<<endl;
	     goto five;
	     }
	   }
	  ...
	  {
	    ten:
	    cout<<"\n\t\t\t Enter Initial Amount (>= ZMK 1000) : ";
		cin>>blnc;
		if(blnc<1000){
	     cout<<"\n\t\t\t Please Enter greater than ZMK 1000"<<endl;
		  goto ten;
		  }
	  }
    ...
    void deposit()   // Deposit
    {
      ...
      if(amnt>=100)
      {
	   blnc=blnc+amnt;
	    ...
	    {
		 cout<<"\n\n\n\t\t\t Amount Should be Greater than equal ZMK 100 "<<endl<<endl<<endl;
		 goto dep;
		 }
		 cout<<"\n\n\n\n\t\t\t You have Deposited Successfully ";
		 cout<<"\n\n\n\n\n\n\t\t\t Current Balance is ZMK"<<blnc;
		getch();
	  }
	  ...
	  void blncenquiry()     // Balance Enquiry
	  {
	    ...
	    cout<<"\n\n\n\n\n\t\t\t   Your Available balance is ZMK"<<blnc;
		getch();
	   }
